...
namespace Db_Final
{
    public partial class SolarView : Form
    {
        public SolarView()
        {
            InitializeComponent();
        ...
        private void SolarView_Load(object sender, EventArgs e)
        {
        ...
        private void guna2Button8_Click(object sender, EventArgs e)
        {
            if (guna2DataGridView1.SelectedRows.Count > 0)
            {
                ...
                string deleteQuery = "DELETE FROM Solar WHERE LocationId = @LocationId";
                var con = Configuration.getInstance().getConnection();
